...
class DemoDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (app()->environment('production')) {
            $this->command->error('Cannot run demo data seeder in production!');
            return;
        }
    ...
    private function calculateGrade($marks, $fullMark)
    {
    ...
    private function calculateGPA($marks, $fullMark)
    {
        $percentage = ($marks / $fullMark) * 100;
