...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Create Period</h1>
        ...
        <form action="{{ route('periods.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g., Period 1, Morning Assembly" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="time" name="start_time" id="start_time" value="{{ old('start_time') }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('start_time')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="end_time" id="end_time" value="{{ old('end_time') }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('end_time')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', 0) }}" min="0" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul class="text-sm text-blue-700 space-y-1">
            <li>• Periods define time slots for classes throughout the day</li>
            <li>• Each period must have a unique time range on its day</li>
            <li>• Order determines the sequence of periods in the schedule</li>
            <li>• Break times can be created as periods with appropriate names</li>
        </ul>
    </div>
</div>
@endsection
