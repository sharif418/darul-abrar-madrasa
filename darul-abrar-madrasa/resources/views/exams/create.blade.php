        ...
        <form method="POST" action="{{ route('exams.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <select name="is_result_published" id="is_result_published" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="0" {{ old('is_result_published', '0') == '0' ? 'selected' : '' }}>Results Not Published</option>
                        <option value="1" {{ old('is_result_published') == '1' ? 'selected' : '' }}>Results Published</option>
                    </select>
                </div>
            </div>
