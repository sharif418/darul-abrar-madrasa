...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6 max-w-2xl">
        <h3 class="text-sm font-semibold text-blue-900 mb-2">💡 Tips for Creating Departments</h3>
        <ul class="text-sm text-blue-800 space-y-1">
            <li>• Use clear and descriptive names (e.g., "Hifz Department", "Qirat Department")</li>
            <li>• Keep codes short and uppercase (e.g., "HIFZ", "QIRAT", "TAFSIR")</li>
            <li>• Add a brief description to help identify the department's purpose</li>
            <li>• You can assign teachers and create classes after creating the department</li>
        </ul>
    </div>
</div>
@endsection
