...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'guardians.*.relationship_type' => ['required', 'in:father,mother,legal_guardian,grandparent,uncle,aunt,sibling,other'],
    ...
    public function messages(): array
    {
        return [
            ...
            'guardian_password.required' => 'Guardian password is required.',
            'guardian_password.min' => 'Guardian password must be at least 6 characters.',
